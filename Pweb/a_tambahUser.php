...
<body class="beranda">
    ...
    <section class="add">
        <?php
            ...
            $sql = "INSERT INTO user (username,jenis_kelamin,alamat,password,email,kontak) VALUES ('$username','$jenis_kelamin','$alamat','$password','$email','$kontak')";
    ...
    <div class="row mt-35">
        ...
        <form class="tambah" method="POST" action="">
            ...
            <label>Kontak</label>
            <input type="tel" name="kontak" required><br>
