...
<body>
    ...
    <section class="events">
        <h1 class="heading">Daftar Kamar</h1>

        <div class="table-container">
            <?php
                $sql = "SELECT * FROM daftar_kamar";
                ...
                if (mysqli_num_rows($result) > 0){
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td>" . $row['Kesediaan_kamar'] . "</td>";
                        echo "<td>" . $row['nama_pasien'] . "</td>";
                        echo "<td>" . $row['tanggal_masuk'] . "</td>";
                        echo "<td>";
                        echo "<a href='a_editkamar.php?id=" . $row['id_kamar'] . "' class='edit-btn'>Edit</a> ";
                        echo "</td>";
                        echo "</tr>";
                    }
                    echo "</table>";
